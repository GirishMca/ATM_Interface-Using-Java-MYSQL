...
public class Statements {
    public void stateView(int id) throws SQLException {
        ...
        int i = 0;
        while (rst.next()) {
            model.addRow(new Object[] { Integer.valueOf(rst.getInt("transid")),
                (rst.getString("stat").equals("dep")) ? rst.getString("amount") : "-",
                (rst.getString("stat").equals("withdraw")) ? rst.getString("amount") : "-",
                Integer.valueOf(rst.getInt("bal")) });
            i++;
        }
